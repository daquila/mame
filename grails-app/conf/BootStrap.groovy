...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Match f6m1 = new Match(teamOne:mamelucoGonzales, scoreTeamOne:null, teamTwo:flowerPower, scoreTeamTwo:null).save(flush:true)
        Match f6m2 = new Match(teamOne:astonBirra, scoreTeamOne:null, teamTwo:cirujas, scoreTeamTwo:null).save(flush:true)
        Match f6m3 = new Match(teamOne:mataJuniors, scoreTeamOne:null, teamTwo:pacheco, scoreTeamTwo:null).save(flush:true)
